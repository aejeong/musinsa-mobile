...
var bannerSlot = document.querySelector('#banner-slot');
init();
...
function setBannerImg() {
  for (var i = 0; i < _index.VISUAL_BANNERS.length; i++) {
    var div = document.createElement('div');
    div.insertAdjacentHTML('afterBegin', "<img src='".concat(_index.VISUAL_BANNERS[i].imageUrl, "' alt=\"main-banner\" />\n\n     <div class=\"slot-info-wrapper\">\n      <span class=\"slot-desc-type\">").concat(_index.VISUAL_BANNERS[i].type, "</span>\n      <p class=\"slot-desc\">\n      ").concat(_index.VISUAL_BANNERS[i].title, "\n      <span class=\"slot-sub-desc\">").concat(_index.VISUAL_BANNERS[i].description, "</span>\n      </p>\n      </div>\n     "));
    div.classList.add('swiper-slide', 'slot');
    bannerSlot.appendChild(div);
  }
}

function initSwiper(selectorName, options) {
